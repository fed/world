...
},{"d3":1,"topojson":3}],3:[function(require,module,exports){
...
var visited = { fillKey: 'visited' };
var outstanding = { fillKey: 'outstanding' };
...
var map = new _datamaps2.default({
  ...
  data: _data2.default,
  fills: {
    visited: _constants.colors.visited,
    outstanding: _constants.colors.outstanding,
    defaultFill: _constants.colors.default
  },
  geographyConfig: {
    hideAntarctica: false,
    borderWidth: 1,
    borderColor: _constants.colors.border,
    highlightFillColor: _constants.colors.highlight,
    highlightBorderColor: _constants.colors.highlightBorder,
...
},{"./constants":4,"./data":5,"datamaps":2}]},{},[6]);
